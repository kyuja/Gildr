...
export default function TabsLayout() {
  return (
    ...
    <Tabs screenOptions={{ headerShown: false }}>
      <Tabs.Screen 
      name="home" options={{ 
        title: "Hauptmenü", headerTitleAlign: 'center',tabBarLabelStyle: {fontSize: 13, borderTopLeftRadius: 24,backgroundColor: '#222222', borderTopWidth: 0, position: 'absolute',overflow: 'hidden',},
