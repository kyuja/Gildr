...
const categories: Category[] = [
  { id: "1", name: "Generic Title", subheading:"Bergedorfer Weg 17A", heart:true},
  { id: "2", name: "Generic Title", subheading:"Ort: Landstraße 100", heart:true},
  { id: "3", name: "Generic Title", subheading:"", heart:true },
                    ...
                    renderItem={({ item }) => (
                      ...
                      >
                        <View style={styles.cardInner}>
                          ...
                          <Text style={styles.cardTextSubheader}>{item.subheading}</Text>
