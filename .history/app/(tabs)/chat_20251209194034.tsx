...
const messages = [
        { id: 1, text: "Das freut mich!", animated: false },
        { id: 2, text: "Wann haben wir eigentlich das nächste Treffen geplant?" , animated: false },
        { id: 3, text: "Am nächsten Montag um 18 Uhr" , animated: false }
];
