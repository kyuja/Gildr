...
export default function ChatLayout() {
    ...
    const sendSoundRef = React.useRef<Audio.Sound | null>(null);
    ...
    const startInitialSequence = () => {
        messages.forEach((msg,index) => {
            ...
            }, (index + 1) * 1700) as unknown as number;
    ...
    return (
        ...
        <ScrollView contentContainerStyle={styles.messageArea} ref={scrollViewRef} onContentSizeChange={() => scrollViewRef.current?.scrollToEnd()}>
