...
const categories: Category[] = [
  { id: "1", name: "Generic Title", subheading:"Weitere Infos", heart:},
  { id: "2", name: "Generic Title", subheading:"Weitere Infos" },
  { id: "3", name: "Generic Title", subheading:"Weitere Infos" },
  { id: "4", name: "Generic Title", subheading:"Weitere Infos" }
];
