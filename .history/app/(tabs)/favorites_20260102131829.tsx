...
const categories: Category[] = [
  { id: "1", name: "Generic Title", location:"Bergedorfer Weg 17A", heart:true},
  { id: "2", name: "Generic Title", location:"Ort: Landstraße 100", heart:true},
  { id: "3", name: "Generic Title", location:"Harburger Straße 3", heart:true },
  { id: "4", name: "Generic Title", location:"Mönckebergstraße", heart:true }
];
