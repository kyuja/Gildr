...
const categories: Category[] = [
  { id: "1", name: "Generic Title", location:"Ort: Bergedorfer Weg 17A", heart:true},
  { id: "2", name: "Generic Title", location:"Ort: Landstraße 100", heart:true},
  { id: "3", name: "Generic Title", location:"Ort: Lohbrügger Landstraße 108B", heart:true },
  { id: "4", name: "Generic Title", location:"Ort: Korachstraße 10b", heart:true }
];
                    ...
                    renderItem={({ item }) => (
                      ...
                      >
                        <View style={styles.cardInner}>
                          ...
                          <Text style={styles.cardTextSubheader}>{item.}</Text>
                        </View>
                      </TouchableOpacity>
                    )}
                  />
