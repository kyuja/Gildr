...
export default function manageGuildMembers() {
    ...
    const [memberDeleteFlag, setMemberDeleteFlag] = React.useState<number[]>([manageGuildMembers.i]);
    ...
    const isMarkedForDeletion = memberDeleteFlag.includes(memberDeleteFlag.id);
        ...
        <View style={{backgroundColor:'white',borderRadius:10,padding:10,marginTop:10, height:300}}>
            <ScrollView>
                {members.map( (member) => (
                    ...
                    <Ionicons name="remove-circle" size={20} style={{position:'absolute', right:10,padding:10}}></Ionicons>
                    </View>
                ))}
            </ScrollView>
        </View>
